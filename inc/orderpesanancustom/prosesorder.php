...
if(isset($_POST) & !empty($_POST)){
		$pesan = "Pesanan diproses";
		$kode = $_POST['kode'];
		$tanggal = date('Y-m-d H:i:s');

		//$query = "INSERT INTO trackpesanan (kode_pesanan, status, pesan, tanggal) VALUES ('$kode', 'Sedang Diproses', '$pesan', '$tanggal')";
		//$query = mysqli_query($connectdb,$query);

		//if($query){
				$query1 = "UPDATE pesanancustom SET status='Sedang Diproses', pesan='$pesan' WHERE kode=$kode";
...
<div align="center">
	...
	<h2>
	<?php
	echo "Konfirmasi proses desain ".$sql['username'];
	?></h2>
	<br>
</div>
...
?>
		<tr>
			...
			<td><img src="<?php echo $sql["gambar"]; ?>" alt="Gambar menu" width="50" height="50"></td>
		</tr>
<?php
//}
?>
...
<div align="center">
	<form action="" method="post">
		...
		<input type="submit" value="Proses Desain" />
	</form>
</div>